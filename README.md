...
| **Alokita** | Wide circular gaze | Expanded peripheral awareness, reduced tunnel vision |
...
| **Anuvritta** | Rapid vertical saccades (REM-like) | Intensive processing, memory consolidation (hypothesis) |
| **Avalokita** | Vertical with downward bias | Grounding, body awareness, reduced dissociation |
...
| **Sleep REM** | Slow figure-8 + theta binaural beats | Pre-sleep relaxation, REM-like entrainment |
...
- Mood assessment before and after each session (animated candle flames)
...
Some patterns are based on well-researched protocols. Others are hypotheses. Each pattern's info panel marks the evidence level:

- 🟢 **Researched** -- clinical studies directly support the mechanism (Pralokita, EMDR Classic, Trataka)
- 🟡 **Preliminary** -- related research supports the mechanism (Sama, Sachi, Alokita, Nimilita, EMDR Diagonal)
- ⚪ **Hypothesis** -- logical chain grounded in research, not directly tested (Ullokita, Avalokita, Anuvritta, Sleep REM)

---

## 🔒 Privacy by Design

No servers, no accounts, no analytics, no trackers. Session history, mood logs, and gaze heatmaps are stored exclusively in your browser via IndexedDB. Nothing leaves your device. The code is open for anyone to inspect.
...
🇬🇧 English · 🇷🇺 Русский · 🇪🇸 Español · 🇧🇷 Português · 🇩🇪 Deutsch · 🇫🇷 Français · 🇯🇵 日本語
...
Star this repo if you like the project. Open an [Issue](https://github.com/CorazonCruzo/saccada/issues) to report bugs or suggest features. Fork, branch, PR -- contributions welcome.
...
*Created with the assistance of AI tools. Saccada is designed by a human, implemented with AI assistance.*
