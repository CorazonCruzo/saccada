...
export const en: Translation = {
  ...
  reflection: {
    ...
    skip: 'Skip',
    save: 'Save',
    notePlaceholder: 'Any thoughts or observations...',
    question: {
      calming: 'Did you feel relaxation or calm?',
      activating: 'Did you feel energized or alert?',
      focusing: 'Did you notice increased focus?',
      processing: 'Did you feel an emotional shift?',
    },
    ratingLabels: ['Not at all', 'A little', 'Moderately', 'Quite a bit', 'Very much'],
  },
  history: {
    title: 'History',
  ...
  about: {
    ...
    authorBody: 'Saccada is created by Anastasiia Chestnykh, a senior frontend engineer and design engineer with 6+ years of experience in React, TypeScript, WebAudio, Canvas, and real-time browser applications. Saccada started as a personal research project at the intersection of creative technology, neuroscience, and Indian classical dance traditions.',
