...
export const sama: PatternConfig = {
  ...
  phases: [
    ...
    { type: 'eyes-closed', duration: 30_000, instruction: 'Колокольчик — закройте глаза. Наблюдайте за ощущениями.' },
    { type: 'fixation', duration: 30_000, instruction: 'Колокольчик — откройте глаза. Мягко верните взгляд к точке.' },
  ],
...
export const nimilita: PatternConfig = {
  ...
  phases: [
    ...
    { type: 'eyes-closed', duration: 30_000, instruction: 'Колокольчик — закройте глаза полностью. Дышите животом.' },
    { type: 'fixation', duration: 30_000, instruction: 'Колокольчик — мягко откройте глаза. Верните внимание к точке.' },
  ],
...
export const anuvritta: PatternConfig = {
  ...
  phases: [
    ...
    { type: 'fixation', duration: 10_000 },
    { type: 'movement', duration: 20_000 },
    { type: 'eyes-closed', duration: 10_000, instruction: 'Колокольчик — закройте глаза. Обратите внимание на ощущения за веками.' },
  ],
...
export const avalokita: PatternConfig = {
  ...
  phases: [
    ...
    { type: 'eyes-closed', duration: 10_000, instruction: 'Колокольчик — закройте глаза. Ощутите контакт тела с поверхностью.' },
  ],
...
export const trataka: PatternConfig = {
  ...
  phases: [
    ...
    { type: 'eyes-closed', duration: 30_000, instruction: 'Колокольчик — закройте глаза. Наблюдайте остаточный образ пламени. Следующий колокольчик — сигнал открыть глаза.' },
    { type: 'fixation', duration: 60_000, instruction: 'Колокольчик — откройте глаза. Снова сосредоточьтесь на пламени.' },
    { type: 'eyes-closed', duration: 30_000, instruction: 'Закройте глаза. Образ может быть другого цвета — это нормально. Колокольчик подскажет, когда открыть глаза.' },
    { type: 'fixation', duration: 60_000, instruction: 'Колокольчик — откройте глаза. Последний раунд. Мягко, без напряжения.' },
...
export const sleepRem: PatternConfig = {
  ...
  phases: [
    ...
    { type: 'eyes-closed', duration: 90_000, instruction: 'Колокольчик — закройте глаза. Позвольте телу расслабиться. Если заснёте — это хорошо.' },
  ],
