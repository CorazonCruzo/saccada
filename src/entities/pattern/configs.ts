...
export const sama: PatternConfig = {
  ...
  audioConfig: { mode: 'drone', frequency: 130.81, waveform: 'sine', droneIntervals: [1, 1.5, 2, 0.5] },
...
export const sachi: PatternConfig = {
  ...
  visual: 'bindu',
  trajectoryParams: { amplitude: 0.2, easing: 'ease-in-out' },
  cycleDuration: 2000,
  defaultSessionDuration: 180_000,
  phases: [
...
export const ullokita: PatternConfig = {
  ...
  trajectory: 'vertical',
  visual: 'bindu',
  trajectoryParams: { amplitude: 0.3, easing: 'sine', bias: 'up' },
  cycleDuration: 3000,
  defaultSessionDuration: 120_000,
  phases: [
  ...
  audioConfig: { mode: 'rhythmic', frequency: 432, waveform: 'triangle', rhythmBPM: 40 },
  requiresHeadphones: false,
...
export const anuvritta: PatternConfig = {
  ...
  trajectory: 'vertical',
  visual: 'bindu',
  trajectoryParams: { amplitude: 0.25, easing: 'linear' },
  cycleDuration: 800,
  defaultSessionDuration: 120_000,
  phases: [
...
export const avalokita: PatternConfig = {
  ...
  trajectory: 'vertical',
  visual: 'bindu',
  trajectoryParams: { amplitude: 0.3, easing: 'sine', bias: 'down' },
  cycleDuration: 3500,
  defaultSessionDuration: 120_000,
  phases: [
  ...
  audioConfig: { mode: 'rhythmic', frequency: 256, waveform: 'sine', rhythmBPM: 45 },
  requiresHeadphones: false,
...
export const sleepRem: PatternConfig = {
  ...
  trajectory: 'figure8',
  visual: 'bindu',
  trajectoryParams: { amplitude: 0.25, easing: 'sine' },
  cycleDuration: 6000,
  defaultSessionDuration: 300_000,
  phases: [
